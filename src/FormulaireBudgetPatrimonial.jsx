    ...
    >
                    ...
                    return (
                      <tr key={i}>
                        {showCategory && (
                          <td
                            rowSpan={rowSpan}
                            className="text-white border border-black px-1 py-0.5 text-center align-middle [writing-mode:vertical-rl] rotate-180 font-semibold"
                          >
                            {a.categorie}
                          </td>
                        )}
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-3">
        <button
          type="button"
          onClick={handleSave}
          className="border-2 border-black bg-[#e6c08f] px-4 py-3 font-semibold text-black"
        >
          Enregistrer
        </button>
        ...
        <button
          ...
          className="border-2 border-black bg-[#d9d9d9] px-4 py-3 font-semibold text-black"
        >
          Télécharger le PDF
        </button>
        ...
        <button
          ...
          className="border-2 border-black bg-black px-4 py-3 font-semibold text-white"
        >
